...
export class ImageOnlyMdMecMapper {
    static map(data: ImageOnlyParsedType): ImageOnly {
    ...
    private static mapArtReference(data: ImageOnlyParsedType): MdArtReference[] {
    ...
    private static mapLocalizedInfo(data: ImageOnlyParsedType): MdLocalizedInfo[] {
    ...
    private static mapAltIdentifier(data: ImageOnlyParsedType): MdAltIdentifier[] {
